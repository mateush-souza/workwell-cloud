...
## Diagrama da solução
![Diagrama WorkWell](link-para-imagem-do-diagrama)
...
2.  Abra o ficheiro `deploy.sh` e preencha as variáveis:
    * `ORACLE_CONNECTION`
    * `MONGODB_CONNECTION`
    * `REDIS_CONNECTION`
    * `JWT_SECRET`
...
* **[script_bd.sql](script_bd.sql):** Script DDL para a criação da estrutura do banco de dados Oracle.
